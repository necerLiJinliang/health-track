...
export function ProviderAvailabilityManager({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(error.message || "Failed to add availability slot. Please try again.");
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleDelete = async (availabilityId: number) => {
    ...
    try {
      ...
      setError(error.message || "Failed to delete availability slot. Please try again.");
    } finally {
      setIsDeleting(null);
    }
  };
    ...
    <div className="border rounded-lg p-4">
      ...
      <div>
        ...
        {isLoading ? (
          ...
          <p className="text-gray-500">No availability slots have been added yet.</p>
        ) : (
              ...
              >
                <div>
                  <p className="font-medium">
                    {formatDateTime(availability.start_time)} - {formatDateTime(availability.end_time)}
                  </p>
                ...
                <Button
                  ...
                  disabled={isDeleting === availability.id || availability.is_booked}
                >
