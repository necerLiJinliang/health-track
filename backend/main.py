...
from routers import users, providers, appointments, challenges, family_groups, invitations, auth, providers_availability
...
app.include_router(providers_availability.router)
